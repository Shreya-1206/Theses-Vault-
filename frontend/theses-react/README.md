# ThesesVault Frontend

Welcome to the ThesesVault frontend repository! This repository contains the frontend codebase for the ThesesVault project.

## theses-react

The `theses-react` folder contains all the frontend code for the ThesesVault web application built using React.
...
For more information about the ThesesVault project, please refer to the [main project README](../README.md).
